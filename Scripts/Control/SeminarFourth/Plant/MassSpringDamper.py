...
class MassSpringDamper(Plant):
    ...
    def StateEquation(self, curState: np.ndarray, curInput: np.ndarray, param: Param) -> np.ndarray:
        ...
        diffState[1] = (curInput[0] - param.springCoef * curState[0] - param.viscousCoef * curState[1] - curInput[1]) / param.mass
    ...
    def PushStateToLoggerImpl(self, curInput: np.ndarray, dataLogger: DataLogger) -> None:
        ...
        dataLogger.PushData(curInput[1], "Disturbance")
    ...
    def PushStateForPlotImpl(self, curInput: np.ndarray, graphPlotter: GraphPlotter) -> None:
        ...
        """
        graphPlotter.PushPlotYData(self.stateVariable_[0], "Actual", "Position")
        graphPlotter.PushPlotYData(self.stateVariable_[1], "Actual", "Velocity")
        graphPlotter.PushPlotYData(curInput[0], "InputForce", "Force")
        graphPlotter.PushPlotYData(curInput[1], "Disturbance", "Force")
